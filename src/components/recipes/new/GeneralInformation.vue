    ...
    <div class="border-top py-1">
      ...
      <div>
        <div class="mb-3">
          ...
          >
          <base-input type="number" id="prep-time" placeholder="0" v-model="recipeData.prepTime"></base-input>
        </div>
        <div class="mb-3">
          <label for="cook-time" class="form-label"
            >Cook Time <span style="color: #cb3a31">*</span></label
          >
          <base-input type="number" id="cook-time" placeholder="0" v-model="recipeData.cookTime"></base-input>
        </div>
        <div class="mb-3">
          <label for="prep-time" class="form-label"
...
export default {
  ...
  methods: {
    totalTime(data) {
      this.recipeData.totalTime = parseInt(this.recipeData.prepTime) + parseInt(this.recipeData.cookTime)
    },
    addIngredient(item) {
