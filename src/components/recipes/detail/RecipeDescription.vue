<template>
  <div
    class="my-2 p-4 d-flex flex-column-reverse flex-lg-row justify-content-center border border-secondary-sublet rounded"
  >
    <div class="pe-lg-4">
      ...
      >
        ...
        <div class="w-75 my-3 mx-auto ps-lg-4 pe-3">
          ...
          <p class="my-0">{{ recipeData.preparationTime + recipeData.cookTime }} Mins</p>
        </div>
      </div>
      ...
      <p class="my-3">Recipe By Halász Emese</p>
      <button class="btn fav-btn px-3 py-2 rounded-pill">
        <i class="fas fa-heart pe-2" style="color: red"></i>Add To Favorite
      </button>
    </div>
    <div class="ps-lg-4">
      <img
        :src="`@/../../public/images/${recipeData.image}`"
        alt="Food"
